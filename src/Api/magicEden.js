...
export const GetCollectionList = async () => {
	...
	return await fetch("/v2/collections?offset=0&limit=500", {method: "GET"}).then(response => response.json())
	.catch(error => console.log(error));
}

export const getCollectionStats = async(collectionSymbol) => {
	return await fetch("/v2/collections/" + collectionSymbol + "/stats", {method: "GET"})
