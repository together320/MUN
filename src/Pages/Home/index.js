...
function SharedItem(props) {
    return <Box className="w-[431px] h-[340px] p-[32px] flex flex-col" sx={{
...
export default function Home() {
    return <Container>
        ...
        <Box sx={{background: "linear-gradient(267.58deg, #0B0E27 0%, #2D325B 175.24%);"}}>
            <Box className="py-[100px] bg-no-repeat bg-right" style={{backgroundImage: `url(/images/home/SolanaBlur.png)`}}>
                <Box className="flex justify-center mb-[49px]">
                    <OperateHeaderText className="mr-6">
                        We operate on
                    </OperateHeaderText>
                    <img src="/images/home/SolanaText.png" alt="SolanaText" />
                </Box>
                <Box className="flex gap-[140px] justify-center">
