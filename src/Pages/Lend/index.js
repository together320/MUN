...
function DesktopCollectionItem({item, chooseAll}){
    ...
    !box-border hover:box-content ${selected ? "border-[1px] border-[#5C84FF]" : "border-[1px] border-[#1B1E3D]"}`}
        ...
        <MintPriceText className="flex ml-[14px] mr-[18px] cursor-pointer !w-[70px] break-all" style={{color : !selected ? '#9395aa' : '#5C84FF'}}>{item.name}</MintPriceText>
                        ...
                        <Box className="flex justify-center items-center">
                            ...
                            }
                            {
                                ...
                                <Box className="flex cursor-pointer items-center" style={{ color: '#494D73' }}>
                                    ...
                                    <CollectionButton className={`text-center transition duration-300 hover:duration-300 hover:bg-[#291d0b50] mr-[7px]`} style={{borderColor : '#5C84FF', maxWidth : '110px'}}>
                                        50 SOL
                                    </CollectionButton>
                                </Box>
                            }
