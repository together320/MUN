...
function NavItem({active, title, url}) {
    ...
    :
        <Box className="flex flex-col justify-center">
            ...
            <Box className="mr-[40px] 2xl:mr-[60px] mt-[7px] h-[7px] w-[7px] rounded-[7px] bg-[#5C84FF]" style={{opacity : 0}}></Box>
        </Box>
}
...
/*         _uploadProfile(id, e.target.files[0])
    ...
    if (isDesktop) {
        return <Box className="pl-[50px] pr-[40px] pt-[24px] pb-[6px] xl:pb-[12px] flex items-center">
            <img src="/logo.svg" className="cursor-pointer mr-[30px]" alt="Logo" onClick={() => navigate("/home")}/>
            {
